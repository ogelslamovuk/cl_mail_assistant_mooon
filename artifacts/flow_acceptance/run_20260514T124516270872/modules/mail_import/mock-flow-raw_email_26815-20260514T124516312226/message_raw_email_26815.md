...
- Raw email: D:\JetBrains\cl_mail_assistant_mooon\artifacts\flow_acceptance\run_20260514T124516270872\modules\mail_import\mock-flow-raw_email_26815-20260514T124516312226\raw_email_raw_email_26815.eml
...
- Suggested next step: Переслать письмо в отдел маркетинга/SMM или ответственному за практику.
...
<!-- MESSAGE_DOSSIER_PAYLOAD_START -->
{
  ...
  "raw_path": "D:\\JetBrains\\cl_mail_assistant_mooon\\artifacts\\flow_acceptance\\run_20260514T124516270872\\modules\\mail_import\\mock-flow-raw_email_26815-20260514T124516312226\\raw_email_raw_email_26815.eml",
  ...
  "modules": {
    ...
    "attachment_extraction": {
      ...
      "subject": "",
      "raw_path": "D:\\JetBrains\\cl_mail_assistant_mooon\\artifacts\\flow_acceptance\\run_20260514T124516270872\\modules\\mail_import\\mock-flow-raw_email_26815-20260514T124516312226\\raw_email_raw_email_26815.eml",
      "message_file_path": "D:\\JetBrains\\cl_mail_assistant_mooon\\artifacts\\flow_acceptance\\run_20260514T124516270872\\modules\\mail_import\\mock-flow-raw_email_26815-20260514T124516312226\\message_raw_email_26815.md",
      "items": []
    },
    "early_classification": {
      ...
      "proposed_action_text": "Переслать письмо в отдел маркетинга/SMM или ответственному за практику.",
    ...
    "identity_context_enrichment": {
      ...
      "debug": {
        ...
        "subject": "",
        "paths": {
          "parsed_email_path": "D:\\JetBrains\\cl_mail_assistant_mooon\\artifacts\\flow_acceptance\\run_20260514T124516270872\\modules\\mail_import\\mock-flow-raw_email_26815-20260514T124516312226\\message_raw_email_26815.md",
          "attachment_report_path": "D:\\JetBrains\\cl_mail_assistant_mooon\\artifacts\\flow_acceptance\\run_20260514T124516270872\\modules\\mail_import\\mock-flow-raw_email_26815-20260514T124516312226\\message_raw_email_26815.md"
        },
        "lookup_keys": {
    ...
    "case_thread_binding": {
      ...
      "registry_path": "D:\\JetBrains\\cl_mail_assistant_mooon\\artifacts\\flow_acceptance\\run_20260514T124516270872\\state\\case_thread_registry.xlsx",
    ...
    "llm_understanding": {
      ...
      "structured_output": {
        ...
        "suggested_next_step": "Переслать письмо в отдел маркетинга/SMM или ответственному за практику.",
        "risk_level": "medium",
        "needs_human": true
      }
    },
    ...
    "decision_layer": {
      ...
      "decision_reason": "Переслать письмо в отдел маркетинга/SMM или ответственному за практику.",
      "missing_data": [],
      "risks": [],
      "knowledge_item_ids": [],
      "routing_item_ids": [],
    ...
    "draft_builder": {
      ...
      "created_at": "2026-05-14T12:45:16.651039+00:00",
      "dossier_path": "D:\\JetBrains\\cl_mail_assistant_mooon\\artifacts\\flow_acceptance\\run_20260514T124516270872\\modules\\mail_import\\mock-flow-raw_email_26815-20260514T124516312226\\message_raw_email_26815.md",
      "revisions": [],
      "inputs": {
    ...
    "telegram_operator_delivery": {
      ...
      "error": "",
      "created_at": "2026-05-14T12:45:22.579645+00:00",
      "dossier_path": "D:\\JetBrains\\cl_mail_assistant_mooon\\artifacts\\flow_acceptance\\run_20260514T124516270872\\modules\\mail_import\\mock-flow-raw_email_26815-20260514T124516312226\\message_raw_email_26815.md",
      "source_dossier_path": "D:\\JetBrains\\cl_mail_assistant_mooon\\artifacts\\flow_acceptance\\run_20260514T124516270872\\modules\\mail_import\\mock-flow-raw_email_26815-20260514T124516312226\\message_raw_email_26815.md",
      "case_id": "case-000001",
      "thread_id": "thread-000001",
      ...
      "telegram_operations": [
        ...
        },
        {
          ...
          "ok": true,
          "callback_query_id": "cb_action",
          "text": "Действие зафиксировано. Реальная маршрутизация пока не подключена."
        }
      ],
      "callback_data": [
        "ma|approve|fe54afcf046099e7",
        "ma|needs_edit|fe54afcf046099e7",
        "ma|handoff|fe54afcf046099e7",
        "ma|ignore|fe54afcf046099e7",
        "ma|action_request|fe54afcf046099e7"
      ],
      "keyboard": [
        {
          "action": "approve",
          "label": "✅ Утвердить",
          "callback_data": "ma|approve|fe54afcf046099e7"
        },
        {
          "action": "needs_edit",
          "label": "✏️ На доработку (LLM)",
          "callback_data": "ma|needs_edit|fe54afcf046099e7"
        },
        {
          "action": "handoff",
          "label": "👤 Оператору",
          "callback_data": "ma|handoff|fe54afcf046099e7"
        },
        {
          "action": "ignore",
          "label": "🚫 Игнорировать",
          "callback_data": "ma|ignore|fe54afcf046099e7"
        },
        {
          "action": "action_request",
          "label": "⚡ Выполнить действие",
          "callback_data": "ma|action_request|fe54afcf046099e7"
        }
      ],
      "card_text": "<b>📩 Новое письмо</b>\n\n⚡ Действие зафиксировано: письмо передано в отдел практики/HR в mock-режиме. Реальная маршрутизация пока не подключена.\n\n<b>Письмо</b>\nUID: raw_email_26815\nПолучено: 06.05.2026 11:00\nОт: nikitamaskevich@gmail.com\nТема письма: без темы\nСуть обращения: Никита Маскевич предлагает помощь с видеомонтажом, соцсетями и роликами, приложил ссылку на портфолио.\n\n<b>Кейс</b>\nCase ID: case-000001 · Thread ID: thread-000001\n\n<b>История переписки</b>\nотсутствует\n\n<b>Вложения</b>\nнет\n\n<b>Проверка билетов / Enrichment</b>\nПроверка билетов: не запускалась — письмо не похоже на клиентский билетный вопрос.\n\n<b>Что понял ассистент</b>\nТип обращения: кандидат/портфолио\nЧто хочет отправитель: Никита Маскевич предлагает помощь с видеомонтажом, соцсетями и роликами, приложил ссылку на портфолио.\nСледующий шаг: Переслать письмо в отдел маркетинга/SMM или ответственному за практику.\n\n<b>Что предлагает система</b>\nЧто сделать: Переслать письмо в отдел маркетинга/SMM или ответственному за практику.\n\n<b>Предлагаемое действие</b>\nВерсия предложения: v1\nПереслать письмо в отдел маркетинга/SMM или ответственному за практику.\nТип действия: уведомить отдел\n\n<b>База знаний</b>\nне применялась — письмо не требует клиентской базы знаний по билетам.\n\n<b>Что не хватает</b>\nнет\n\n<b>Риски</b>\nнет\n\n<b>Черновик</b>\nЧерновик не создавался: обращение помечено для ручной обработки ответственными.\n\n<b>Последнее действие</b>\nдействие зафиксировано в mock-режиме",
      "action": "action_request",
      "artifacts_dir": "D:\\JetBrains\\cl_mail_assistant_mooon\\artifacts\\flow_acceptance\\run_20260514T124516270872",
      "card_artifact_path": "D:\\JetBrains\\cl_mail_assistant_mooon\\artifacts\\flow_acceptance\\run_20260514T124516270872\\telegram_operator_delivery\\case-000001\\card_20260514T124522579752.json"
    },
    "operator_actions": {
      "status": "ok",
      "latest_action": {
        ...
        "created_at": "20260514T124522578520",
        "draft_ref": "D:\\JetBrains\\cl_mail_assistant_mooon\\artifacts\\flow_acceptance\\run_20260514T124516270872\\modules\\mail_import\\mock-flow-raw_email_26815-20260514T124516312226\\message_raw_email_26815.md#modules.draft_builder",
        "source_dossier_path": "D:\\JetBrains\\cl_mail_assistant_mooon\\artifacts\\flow_acceptance\\run_20260514T124516270872\\modules\\mail_import\\mock-flow-raw_email_26815-20260514T124516312226\\message_raw_email_26815.md",
        "callback_data": "ma|action_request|fe54afcf046099e7",
        "mock_reply_refs": [],
        "updated_card_ref": "D:\\JetBrains\\cl_mail_assistant_mooon\\artifacts\\flow_acceptance\\run_20260514T124516270872\\telegram_operator_delivery\\case-000001\\card_20260514T124522579752.json",
        "real_email_sent": false,
