...
- Telegram operator demo flow is available for draft building, real Bot API cards, operator actions and mock outbox.
...
- Create a real Telegram operator card when `telegram_operator_delivery.bot_token` and `operator_chat_id` are configured:
